      ...
      {!hasCompletedAnalysis ? (
        ...
        >
          <div className="mx-auto max-w-7xl">
            <div className="locked-results-reveal case-card rounded-[2rem] p-6 md:p-10">
              <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
                <div>
                  <div className="locked-results-reveal flex size-14 items-center justify-center rounded-2xl border border-case-border bg-case-gunmetal">
                    {hasStartedAnalysis ? (
                  ...
                  <h2 className="locked-results-reveal mt-3 text-4xl font-black leading-tight md:text-5xl">
                    Run the analyzer to unlock the mock case intelligence.
                  </h2>

                  <p className="locked-results-reveal mt-5 max-w-xl leading-8 text-case-muted">
                  ...
                  <a
                    href="#analyzer"
                    className="locked-results-reveal signal-button mt-8 inline-flex rounded-full px-6 py-3 text-sm font-black"
                  >
                    Go to Analyzer
                  </a>
                </div>

                <div className="locked-results-reveal rounded-[1.5rem] border border-case-border bg-black/40 p-5">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div
                        key={item}
                        className="locked-results-reveal flex items-center justify-between rounded-2xl border border-case-border bg-case-gunmetal/40 p-4"
                      >
